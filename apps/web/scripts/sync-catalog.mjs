...
function assertCatalog(catalog, version) {
  ...
  if (!Array.isArray(catalog.skills) || catalog.skills.length !== 44) {
    throw new Error("Catalog must contain 44 skills");
  }
  if (!Array.isArray(catalog.packs) || catalog.packs.length !== 9) {
    throw new Error("Catalog must contain 9 packs");
  }
}
