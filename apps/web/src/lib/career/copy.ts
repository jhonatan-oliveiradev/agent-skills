...
export const careerLabCopy = {
  en: {
    ...
    assessment: {
      ...
      diagnosis: "Diagnosis",
      diagnosisBody: "This deterministic result reflects the strongest level supported by the completed challenge signals.",
      demonstrated: "Demonstrated",
      noDemonstrated: "No strong demonstrated signals were recorded in this attempt.",
      strengthenNext: "Strengthen next",
      noStrengthen: "No failed criterion could be mapped from this attempt. Use the next evidence recommendation below.",
      yourNextStep: "Your next step",
      noCuratedStudy: "No curated study module is available for this result yet. Use the next evidence recommendation as the continuation path.",
      studyNow: "Study now",
      ...
      reviewSelected: "Your answer",
      reviewExpected: "Correct answer",
      reviewExplanation: "Explanation",
      reviewOptionNotes: "Option notes",
  ...
  "pt-BR": {
    ...
    assessment: {
      ...
      diagnosisBody: "Este resultado determinístico reflete o nível mais alto sustentado pelos sinais observados nos desafios concluídos.",
      ...
      noStrengthen: "Nenhum critério reprovado pôde ser mapeado nesta tentativa. Use a recomendação de próxima evidência abaixo.",
      yourNextStep: "Seu próximo passo",
      noCuratedStudy: "Ainda não há um módulo de estudo revisado para este resultado. Use a recomendação de próxima evidência como continuação.",
      ...
      reviewCorrect: "Correta",
      reviewIncorrect: "Incorreta",
      reviewSelected: "Sua resposta",
      reviewExpected: "Resposta correta",
      reviewExplanation: "Explicação",
      reviewOptionNotes: "Notas das alternativas",
