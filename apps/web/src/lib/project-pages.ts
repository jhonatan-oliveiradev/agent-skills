      ...
      releases: [
        {
          ...
          groups: [
            ...
            { title: "Studio e roteiro", items: ["Promoção das superfícies qualificadas de plugin, catálogo, instaladores e microsite para Stable no roteiro público, mantendo a maturidade individual das skills distinta do estado Stable da release.", "Manutenção da documentação atual de README/catálogo alinhada a 54 skills canônicas e 11 pacotes ativos, com remoção apenas de copy localizada comprovadamente órfã da Home/Primeiros passos."] },
            { title: "Confiabilidade e manutenção", items: ["Remoção dos helpers de workflow pós-Stable supersededidos, mantendo validate.yml como workflow canônico.", "Hardening do CI no Windows para isolar a integração Next real e tolerar contenção de teardown sem elevar timeouts nem serializar toda a suíte.", "Restauração do contraste dos selects/opções nativos do Method Archive com tokens existentes de superfície/texto, preservando semântica nativa e comportamento de teclado."] },
          ],
        },
        {
          version: "1.0.0",
