      ...
      releases: [
        {
          ...
          date: "Unreleased",
          groups: [
            { title: "Developer Career", items: ["Expanded the 1.1.0 development line to 60 canonical skills and 12 active packs with six independently invokable Developer Career methods.", "Added the browser-local Career Lab with evidence-aware baseline assessments, adaptive roadmap, targeted learning, Professional Evidence Ledger, Market Intelligence, and explicit Career Profile import/export/reset controls.", "Kept Career Lab local-first in V1: no account, cloud sync, billing, first-party model inference, or certification claim is introduced; dev remains the integration branch until a separate production promotion."] },
