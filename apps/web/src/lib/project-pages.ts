      ...
      releases: [
        {
          ...
          date: "Unreleased",
          groups: [
            { title: "Developer Career", items: ["Expanded the 1.1.0 development line to 61 canonical skills and 12 active packs, including six independently invokable Developer Career methods and the executable Sprite Gen pipeline.", "Added the browser-local Career Lab with evidence-aware baseline assessments, adaptive roadmap, targeted learning, Professional Evidence Ledger, Market Intelligence, and explicit Career Profile import/export/reset controls.", "Kept Career Lab local-first in V1: no account, cloud sync, billing, first-party model inference, or certification claim is introduced; dev remains the integration branch until a separate production promotion."] },
      ...
      releases: [
        {
          ...
          date: "Não lançada",
          groups: [
            { title: "Developer Career", items: ["Expansão da linha de desenvolvimento 1.1.0 para 61 skills canônicas e 12 pacotes ativos, incluindo seis métodos Developer Career invocáveis de forma independente e o pipeline executável Sprite Gen.", "Adição do Career Lab local no navegador com avaliações de baseline orientadas por evidências, roadmap adaptativo, aprendizado direcionado, Ledger de Evidências Profissionais, Inteligência de Mercado e controles explícitos de importar/exportar/resetar o Career Profile.", "Manutenção do Career Lab como local-first na V1: nenhuma conta, sincronização em nuvem, cobrança, inferência por modelo first-party ou alegação de certificação é introduzida; dev continua sendo a branch de integração até uma promoção separada para produção."] },
