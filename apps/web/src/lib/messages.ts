...
export interface Messages {
  ...
  readonly gettingStarted: {
    ...
    readonly install: { readonly title: string; readonly summary: string; readonly complete: string; readonly skill: string; readonly pack: string; readonly demoLabel: string };
...
export const messages = {
  en: {
    ...
    roadmap: {
      ...
      stableItem: { title: "Skills marked Stable", summary: "{count} canonical skills are currently marked stable in the catalog. The complete 1.0.0 collection remains available through supported installation paths." },
  ...
  "pt-BR": {
    ...
    roadmap: {
      ...
      stableItem: { title: "Skills marcadas como estáveis", summary: "{count} skills canônicas estão marcadas como estáveis no catálogo neste momento. A coleção completa 1.0.0 continua disponível pelos caminhos de instalação suportados." },
