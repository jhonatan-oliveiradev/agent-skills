...
describe("Evidence Archive", () => {
  it.each([
    ["en", "Don't trust the description. Inspect the result.", "SOURCE / AVAILABLE", "/en/built-with-skills/catalog-experience"],
    ["pt-BR", "Não confie na descrição. Inspecione o resultado.", "FONTE / DISPONÍVEL", "/pt-BR/built-with-skills/catalog-experience"],
  ] as const)("renders an evidence-first editorial archive for %s", async (locale, title, state, leadingHref) => {
