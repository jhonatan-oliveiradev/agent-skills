...
describe("definitive home", () => {
  it.each([
    ["en", "Skills are not prompts. They are working methods.", "30 skills", "6 packs", "2 locales", "This Home was built with Skills.", "Open the method. Inspect the evidence. Judge the result."],
    ["pt-BR", "Skills não são prompts. São métodos de trabalho.", "30 skills", "6 pacotes", "2 idiomas", "Esta Home foi construída com Skills.", "Abra o método. Inspecione a evidência. Julgue o resultado."],
    ...
    expect(container.querySelectorAll(".home-pack-dossier")).toHaveLength(6);
...
describe("foundation navigation targets", () => {
  it("shows an animated terminal demonstration in the installation guide", async () => {
    ...
    expect(screen.getByText("30 skills prontas para usar.")).toBeInTheDocument();
  });
  ...
  it.each([
    ...
    expect(container.querySelectorAll('[data-pack-dossier][data-status="active"]')).toHaveLength(6);
  ...
  it.each([
    ...
    expect(container.querySelectorAll("[data-method-row]")).toHaveLength(30);
