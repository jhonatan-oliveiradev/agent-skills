...
describe("editorial site chrome", () => {
  ...
  it.each([
    [
      ...
      "Open navigation",
      "Built with skills",
      "Inspect real projects, the skills used, and the evidence left after the work shipped.",
      "Roadmap",
      "Release status and individual skill maturity are tracked separately and advance only with evidence.",
      "Career Lab",
      "Build an evidence-aware developer baseline, roadmap, portfolio ledger, and market view without requiring an account or cloud sync.",
    ],
    [
      "pt-BR",
      "Abrir navegação",
      "Feito com habilidades",
      "Inspecione projetos reais, as skills usadas e as evidências que ficaram depois da entrega.",
      "Roteiro",
      "O status da release e a maturidade das skills são acompanhados separadamente e só avançam com evidência.",
      "Career Lab",
      "Construa baseline, roadmap, ledger de portfólio e visão de mercado orientados por evidências, sem exigir conta ou sincronização em nuvem.",
    ],
  ] as const)(
    "turns the %s header into a contextual studio index",
    async (
      locale,
      openLabel,
      proofLabel,
      ...
      const careerLabLink = within(dialog).getByRole("link", { name: careerLabLabel });
      expect(careerLabLink).toHaveAttribute("href", `/${locale}/career-lab`);
      fireEvent.focus(careerLabLink);
      expect(await within(dialog).findByText(careerLabContext)).toBeInTheDocument();
    },
  );
  ...
  it.each([
    ...
    ["en", "/en/career-lab", "Open navigation", "Career Lab", "Build an evidence-aware developer baseline, roadmap, portfolio ledger, and market view without requiring an account or cloud sync."],
    ["pt-BR", "/pt-BR/career-lab", "Abrir navegação", "Career Lab", "Construa baseline, roadmap, ledger de portfólio e visão de mercado orientados por evidências, sem exigir conta ou sincronização em nuvem."],
