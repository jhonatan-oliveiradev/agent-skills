...
const allowedCategories = new Set(["frontend", "product-design", "motion", "game-development", "backend-data", "architecture-engineering", "codebase-intelligence", "quality-testing", "application-security", "engineering-workflow", "brand-design", "writing-communication", "developer-career", "delivery", "meta"]);
