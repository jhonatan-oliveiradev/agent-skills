...
const allowedCategories = new Set(["frontend", "product-design", "motion", "game-development", "backend-data", "architecture-engineering", "quality-testing", "application-security", "engineering-workflow", "delivery", "meta"]);
